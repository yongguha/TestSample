...
public class Constants {
    ...
    public static final int DEF_BACKGROUND = Color.parseColor("#F9F8F9");
    public static final int DEF_MAIN_STRIPE = Color.parseColor("#F23A78");
    public static final int DEF_SUB_STRIPE = Color.parseColor("#D94BF1");
