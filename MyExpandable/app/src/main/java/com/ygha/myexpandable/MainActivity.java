...
public class MainActivity extends AppCompatActivity {
    ...
    private void getData() {
        // 임의의 데이터입니다.
        List<String> listTitle = Arrays.asList("엘리베이터 점검 공지", "CCTV 확장 설치 공지", "지하주차장 물청소 공지","엘리베이터 점검 공지", "CCTV 확장 설치 공지", "지하주차장 물청소 공지");
        ...
        List<String> listDate = Arrays.asList("2021.01.19", "2021.03.02", "2021.03.18","2021.01.19", "2021.03.02", "2021.03.18");
