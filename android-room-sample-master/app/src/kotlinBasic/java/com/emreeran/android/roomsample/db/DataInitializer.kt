...
/**
 * Created by Emre Eran on 27.05.2018.
 */
class DataInitializer(db: SampleDb) {

    private val _userDao = db.userDao()
    private val _postDao = db.postDao()
    private val _commentDao = db.commentDao()
    private val _likeDao = db.likeDao()
