...
public class SmartPlugServiceManager implements OnServiceStateUpdateListener{
    ...
    private static final String SMARTPLUG_SERVICE_PKG = "com.commax.ocf.service.smartplug";
    private static final String SMARTPLUG_SERVICE_NAME = "com.commax.ocf.service.smartplug.SMARTPlugService";



    public SmartPlugServiceManager(MyOCFServer myOCFServer, InCommingHandler handler) {
    ...
    public void bindService(){
        ...
        intent.setComponent(new ComponentName(SMARTPLUG_SERVICE_PKG, SMARTPLUG_SERVICE_NAME));
