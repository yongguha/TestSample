...
public class AirMonitorServiceManager implements OnServiceStateUpdateListener{
    ...
    private static final String AIRQUALITYMONITOR_SERVICE_PKG = "com.commax.ocf.airmonitor";
    private static final String AIRQUALITYMONITOR_SERVICE_NAME = "com.commax.ocf.airmonitor.AirmonitorService";



    public AirMonitorServiceManager(MyOCFServer myOCFServer, InCommingHandler handler) {
    ...
    public void bindService(){
        ...
        intent.setComponent(new ComponentName(AIRQUALITYMONITOR_SERVICE_PKG, AIRQUALITYMONITOR_SERVICE_NAME));
