...
public class MagneticServiceManager implements OnServiceStateUpdateListener {
    ...
    private static final String MAGNETIC_SERVICE_PKG = "com.commax.ocf.magnetic";
    private static final String MAGNETIC_SERVICE_NAME = "com.commax.ocf.magnetic.MagneticService";



    public MagneticServiceManager(MyOCFServer myOCFServer, InCommingHandler handler) {
    ...
    public void bindService(){
        ...
        intent.setComponent(new ComponentName(MAGNETIC_SERVICE_PKG, MAGNETIC_SERVICE_NAME));
