...
public class StandPlugServiceManager implements OnServiceStateUpdateListener{
    ...
    private static final String STANDTPLUG_SERVICE_PKG = "com.commax.ocf.standplug";
    private static final String STANDTPLUG_SERVICE_NAME = "com.commax.ocf.standplug.StandPlugService";



    public StandPlugServiceManager(MyOCFServer myOCFServer, InCommingHandler handler) {
    ...
    public void bindService(){
        ...
        intent.setComponent(new ComponentName(STANDTPLUG_SERVICE_PKG, STANDTPLUG_SERVICE_NAME));
