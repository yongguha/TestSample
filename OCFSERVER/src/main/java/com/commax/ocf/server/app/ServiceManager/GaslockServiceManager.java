...
public class GaslockServiceManager  implements OnServiceStateUpdateListener {
    ...
    public GaslockServiceManager(MyOCFServer myOCFServer, InCommingHandler handler) {
    ...
    public void bindService(){
        ...
        intent.setComponent(new ComponentName("com.commax.ocf.gaslocksvr","com.commax.ocf.gaslocksvr.GaslockService"));
        myOCFServer.bindService(intent, GaslockCon, myOCFServer.BIND_AUTO_CREATE);
    }
    ...
    public void unbindService(){
        if(isBounded) {
            isBounded=false;
            myOCFServer.unbindService(GaslockCon);
        }else{
            Toast.makeText(myOCFServer.mContext,"GasLock is not binded,", Toast.LENGTH_LONG).show();
        }
    }
