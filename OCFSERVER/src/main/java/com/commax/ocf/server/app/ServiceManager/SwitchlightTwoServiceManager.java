...
public class SwitchlightTwoServiceManager implements OnServiceStateUpdateListener {
    ...
    private static final String SWITCH_LIGHT_TWO_SERVICE_PKG = "com.commax.ocf.switchlight.two";
    private static final String SWITCH_LIGHT_TWO_SERVICE_NAME = "com.commax.ocf.switchlight.two.SwitchTwoService";

    public SwitchlightTwoServiceManager(MyOCFServer myOCFServer, InCommingHandler handler) {
    ...
    public void startService(){
        ...
        intent.setComponent(new ComponentName(SWITCH_LIGHT_TWO_SERVICE_PKG,SWITCH_LIGHT_TWO_SERVICE_NAME));
